...
const TallyVendorBillDetail = () => {
    ...
    const handleSync = async () => {
        try {
            ...
            globalToast.error(error?.response?.data?.message || error?.message || 'Failed to sync vendor bill');
        } finally {
            setIsSyncing(false);
        }
    };
                ...
                headerSlot={
                    <div className="flex items-center gap-3">
                        ...
                        <button
                            ...
                            className={`group relative inline-flex items-center gap-2 px-4 py-2 text-sm font-medium border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-1 transition-all duration-200 active:scale-95 ${(isSyncing || isVerified || billInfo?.status !== 'Verified')
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg overflow-visible">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                        ...
                                        <div className="relative">
                                            ...
                                            {vendorForm.selectedVendor && 
                                             vendorForm.selectedVendor.organization_id !== selectedOrganization?.id && (
                            ...
                            <div className="p-8">
                                <div>
                                    ...
                                    <textarea
                                        value={notes || `Bill from ${vendorForm.selectedVendor?.name || 'Vendor'} entered via BillMunshi ${window.location.origin}/tally/vendor-bill/${billInfo.bill_munshi_name || billId}\n\n`}
