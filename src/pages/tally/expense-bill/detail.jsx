...
import { useGetTallyExpenseBillDetails, useVerifyTallyExpenseBill, useSyncTallyExpenseBill } from "@/hooks/api/tally/tallyExpenseBillService";
...
const TallyExpenseBillDetail = () => {
    ...
    return (
        <div className="space-y-5">
            <Card
                title={`Tally Journal Entry Detail`}
                noBorder
                headerSlot={
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg overflow-visible">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                        ...
                                        <div className="relative">
                                            ...
                                            {billForm.selectedVendor && 
                                             billForm.selectedVendor.organization_id !== selectedOrganization?.id && (
                                                <div className="mt-2 p-2 bg-yellow-50 border border-yellow-200 rounded-md text-xs text-yellow-700 flex items-start gap-2">
                                                    ...
                                                    <span>
                                                        <strong>Warning:</strong> The selected vendor belongs to a different organization. This may cause issues during sync.
                                                    </span>
                                                </div>
                                            )}
                                    ...
                                    <div className="overflow-x-auto">
                                        <table className="w-full min-w-[800px]">
                                            ...
                                            <tbody className="bg-white divide-y divide-gray-200">
                                                ...
                                                <tr className="hover:bg-gray-50 transition-colors duration-150">
                                                    <td className="px-4 py-3">
                                                        <span className="text-sm font-medium text-gray-900">IGST</span>
                                                    </td>
                                                    <td className="px-4 py-3">
                                                        <SearchableDropdown
                                                ...
                                                <tr className="hover:bg-gray-50 transition-colors duration-150 bg-blue-50">
                                                    <td className="px-4 py-3">
                                                        <span className="text-sm font-medium text-gray-900">Payable to Vendor</span>
                                                    </td>
                                                    <td className="px-4 py-3">
                                        ...
                                        <div className="flex justify-between items-center">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <input
                                                    ...
                                                    placeholder="0.00"
                                                    disabled={isVerified}
                                                    className={`w-48 px-3 py-2 text-right border border-gray-300 rounded-lg bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 focus:outline-none text-sm font-semibold [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none ${isVerified ? 'opacity-60 cursor-not-allowed bg-gray-100' : ''}`}
                                                    min="0"
                                                    step="0.01"
                                                />
                                            </div>
                            ...
                            <div className="p-8">
                                <div>
                                    ...
                                    <textarea
                                        value={notes || `Bill from ${billForm.selectedVendor?.name || 'Vendor'} entered via BillMunshi ${window.location.origin}/tally/expense-bill/${billInfo.bill_munshi_name || billId}\n\n`}
