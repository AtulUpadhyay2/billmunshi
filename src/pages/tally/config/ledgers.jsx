...
const Ledgers = () => {
  ...
  const filteredGroupedLedgers = useMemo(() => {
    ...
    const filtered = {};
    Object.entries(ledgersData.grouped_ledgers).forEach(
      ...
      <Card title="Tally Ledgers">
        ...
        <div className="mb-6">
          ...
          {searchTerm && (
            <div className="mt-2 text-sm text-gray-600">
              Showing {Object.keys(filteredGroupedLedgers).length} of{" "}
              {Object.keys(grouped_ledgers).length} parent groups
            </div>
          )}
        </div>
        ...
        <div className="space-y-4">
          {Object.keys(filteredGroupedLedgers).length > 0 ? (
            Object.entries(filteredGroupedLedgers).map(
              ([parentName, parentData]) => (
                <div
                  key={parentData.parent_id}
