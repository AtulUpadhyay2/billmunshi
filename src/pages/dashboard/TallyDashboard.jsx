  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      ...
      <Card className="relative overflow-hidden">
        <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-br from-green-500/10 to-blue-500/10 rounded-full transform translate-x-6 -translate-y-6"></div>
...
const UsageAnalytics = ({ usageData }) => {
  ...
  const pieData = [
    { name: 'Vendor Files', value: file_statistics.total_vendor_files, color: '#10B981' },
          ...
          <div className="p-4">
            ...
            <div className="grid grid-cols-2 gap-2 mt-2">
              <div className="text-center">
                <div className="text-lg font-bold text-green-600">{file_statistics.total_vendor_files}</div>
