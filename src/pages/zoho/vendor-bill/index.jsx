...
const ZohoVendorBill = () => {
    ...
    const { data: allBillsData } = useGetVendorBills({ organizationId: selectedOrganization?.id });
    const { data: draftBillsData } = useGetVendorBills({ organizationId: selectedOrganization?.id, status: 'draft' });
    const { data: analysedBillsData } = useGetVendorBills({ organizationId: selectedOrganization?.id, status: 'analysed' });
    const { data: syncedBillsData } = useGetVendorBills({ organizationId: selectedOrganization?.id, status: 'synced' });
                            ...
                            <button
                                onClick={() => {
                                    if (selectedDuplicateBill?.file) {
                                        handleViewFile(selectedDuplicateBill.file, selectedDuplicateBill.billmunshiName);
