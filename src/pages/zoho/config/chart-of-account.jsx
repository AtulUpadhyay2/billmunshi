...
const chartOfAccounts = () => {
    ...
    const {
        ...
        error,
        refetch
    } = useGetChartOfAccountsQuery(selectedOrganization?.id, {
                        ...
                        <div className="overflow-hidden">
                            {isLoading ? (
                                <div className="flex items-center justify-center py-8">
                                    ...
                                    <span className="ml-3 text-slate-600">Loading chart of accounts...</span>
                                </div>
                            ) : isError ? (
                                ...
                                <>
                                    ...
                                    {chartOfAccountsData?.count > 0 && (
                                        <div className="mt-4 px-6 pb-4 text-sm text-slate-500">
                                            Showing {chartOfAccountsData.results.length} of {chartOfAccountsData.count} accounts
                                        </div>
                                    )}
                                </>
                            )}
